    ...
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <header className="sticky top-0 z-50 w-full bg-white border-b border-orange-200 shadow-sm">
        <nav className="flex items-center justify-between py-3 px-4 text-base font-semibold text-gray-700">
          ...
          <div className="hidden md:flex gap-6">
            <a href="#my-book" className="hover:text-orange-600 transition-colors">My Book</a>
            <a href="#albums" className="hover:text-orange-600 transition-colors">Albums & Soundtracks</a>
            <a href="#performances" className="hover:text-orange-600 transition-colors">Performances & Concerts</a>
        ...
        {navOpen && (
          <div className="md:hidden flex flex-col gap-2 px-6 pb-4 bg-white border-b border-orange-200 animate-fade-in">
            <a href="#my-book" className="py-2 hover:text-orange-600 transition-colors" onClick={() => setNavOpen(false)}>My Book</a>
            <a href="#albums" className="py-2 hover:text-orange-600 transition-colors" onClick={() => setNavOpen(false)}>Albums & Soundtracks</a>
            <a href="#performances" className="py-2 hover:text-orange-600 transition-colors" onClick={() => setNavOpen(false)}>Performances & Concerts</a>
            <a href="#contact" className="py-2 hover:text-orange-600 transition-colors" onClick={() => setNavOpen(false)}>Contact</a>
          </div>
        )}
      </header>
      ...
      <div className="flex-1 flex flex-row p-0 md:p-0">
        ...
        <div className="flex-1 flex flex-col p-3 sm:p-4 md:p-8 lg:p-16">
          {/* Top Socials */}
          <div className="flex justify-end gap-6 text-lg mb-8">
          ...
          <div className="flex flex-col md:flex-row gap-12 items-center md:items-start">
            ...
            <div className="max-w-2xl w-full">
              ...
              <div className="text-orange-500 mb-2">Iranian Folk woodwind instrumentalist and composer</div>
              <div className="bg-white/80 border border-orange-100 rounded-2xl shadow p-6 mb-4">
                <div className="text-gray-700 mb-2 text-lg">
                  Born in 1983 in Mashhad, Iran, is an Iranian folk wind instrument player such as Persian Ney, Duduk, Persian Bagpipe, Persian Clarinet, songwriter, composer, and an esteemed member of the Iranian House of Music. He is the son of Mohammad Farbodnia, a renowned Iranian sculptor and graduate of the Ecole des Beaux-Arts in Paris (Class of 1975).
                </div>
                <div className="text-gray-700 text-lg">
                  From early childhood, he was passionate about traditional Iranian wind instruments and began learning the Ney under the guidance of his father. During his teenage years, he studied with several great masters of the Ney and Persian clarinet, including Hassan Kassai, Mohammad Ali Kiani Nejad, and Mohammad Mousavi. He also studied the classical Radif of Persian music with the legendary Mohammad Reza Lotfi, under whose supervision he developed a new fingering technique for the Ney. This technique was later published in his book "Nava-ye Ney" in 2010, which was well-received among students and enthusiasts of the Ney.
                </div>
              </div>
              {/* Group Badges */}
              <div className="flex flex-wrap gap-3 mt-4">
                <span className="bg-black text-white rounded-full px-4 py-2 text-sm font-semibold">Vazir Music Orchestra</span>
                <span className="bg-gray-800 text-white rounded-full px-4 py-2 text-sm font-semibold">Hamnavazan-e Hesar Ensemble</span>
                <span className="bg-orange-200 text-orange-900 rounded-full px-4 py-2 text-sm font-semibold">Sooreh Music Group</span>
                <span className="bg-orange-100 text-orange-800 rounded-full px-4 py-2 text-sm font-semibold">Tār Folk Music Group</span>
                <span className="bg-orange-700 text-white rounded-full px-4 py-2 text-sm font-semibold">The Best of Master Mohammad Reza Lotfi</span>
                <span className="bg-yellow-200 text-yellow-900 rounded-full px-4 py-2 text-sm font-semibold">Khaneyagaran-e Khayyam Ensemble</span>
                <span className="bg-orange-300 text-orange-900 rounded-full px-4 py-2 text-sm font-semibold">Alest Music Group</span>
              </div>
            </div>
          </div>
          ...
          <section id="my-book" className="mt-16 scroll-mt-24 relative">
            ...
            <h2 className="text-3xl font-bold mb-6 text-gray-800 relative z-10">My Book</h2>
            <div className="border-t border-gray-200 pt-6 relative z-10">
              <div className="flex flex-col lg:flex-row items-center justify-center gap-10 bg-gradient-to-br from-orange-50 via-white to-orange-100 p-10 rounded-2xl shadow-xl border border-orange-100">
                ...
                <div className="flex-[2] max-w-xl text-center lg:text-left px-2">
                  <h3 className="text-3xl font-extrabold mb-2 text-orange-700 tracking-tight">Navaye-Ney <span className="ml-2 bg-orange-200 text-orange-900 text-xs font-bold px-2 py-1 rounded-full align-middle">3rd Edition</span></h3>
                  <div className="text-lg text-gray-700 mb-2 font-semibold">Parts for the Ney instrument</div>
                  <p className="text-gray-700 mb-4">
                    The book <span className="font-bold text-orange-700">Navaye Ney</span> was published in 2010 by Chekad Honar Publishing House in Iran. This work presents an innovative fingering method for the Ney, significantly enhancing the ease and efficiency of playing the instrument. The book comprises ten original practice pieces composed by Ali Farbodnia, in addition to a selection of renowned compositions from the Iranian musical repertoire originally written for various instruments, which have been transcribed and arranged for the Ney by the author. <span className="font-bold text-orange-700">Navaye Ney</span> has now reached its <span className="font-bold">third edition</span> and is available to enthusiasts through multiple online platforms.
                  </p>
                  <hr className="my-4 border-gray-300" />
                  <div className="flex flex-col items-center gap-2">
                    <span className="font-bold text-gray-800">-Mahoor-</span>
          ...
          <section id="albums" className="mt-16 scroll-mt-24">
            <h2 className="text-3xl font-bold mb-6 text-gray-800">ALBUMS & SOUNDTRACKS</h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div className="flex flex-col items-center">
                  ...
                  <div className="mt-4 text-center">
                    <div className="font-semibold">Duduk sample pack/company: ancient-sound</div>
                    <a href="https://ancient-sounds.com/product/duduk-sample-pack-vol-2/" target="_blank" rel="noopener noreferrer" className="mt-2 inline-flex items-center gap-2 text-orange-600 hover:text-orange-800 font-medium">
                      ...
                      Link: Duduk player: Ali Farbodnia
                    </a>
                  </div>
                </div>
                {/* Waiting for the Sun */}
                <div className="flex flex-col items-center">
                  ...
                  <div className="mt-4 text-center">
                    <div className="font-semibold">"Waiting for the sun"<br/>Composer: Hisham Kharma</div>
                    <a href="https://youtu.be/xaghY0ipdC0?si=XnblZ-dt7IdSvP95" target="_blank" rel="noopener noreferrer" className="mt-2 inline-flex items-center gap-2 text-orange-600 hover:text-orange-800 font-medium">
                      ...
                      Link: Ney & Duduk player: Ali Farbodnia
                    </a>
                  </div>
                </div>
                {/* Mawlana */}
                <div className="flex flex-col items-center">
                  ...
                  <div className="mt-4 text-center">
                    <div className="font-semibold">"Mawlana" composer: Chaama x Zamane</div>
                ...
                <div className="flex flex-col items-center">
                  ...
                  <div className="mt-4 text-center">
                    <div className="font-semibold">"Habrban" Armenian folk songs<br/>Arrangements by Farya Faraji</div>
                ...
                <div className="flex flex-col items-center">
                  ...
                  <div className="mt-4 text-center">
                    <div className="font-semibold">"Miravi" Fatemeh Mehlaban<br/>composer: Ali Farbodnia</div>
                ...
                <div className="flex flex-col items-center">
                  ...
                  <div className="mt-4 text-center">
                    <div className="font-semibold">"Va Dobareh Bahar" Omid Nasri<br/>composer& lyric: Ali Farbodnia</div>
                    <a href="https://youtu.be/CtCL3cXmxno?si=9AwLUNijLluxeOnz" target="_blank" rel="noopener noreferrer" className="mt-2 inline-flex items-center gap-2 text-orange-600 hover:text-orange-800 font-medium">
                      ...
                      Link: composer& lyric: Ali Farbodnia
                    </a>
                  </div>
                </div>
              </div>
          ...
          <section id="performances" className="mt-16 scroll-mt-24">
            <h2 className="text-3xl font-bold mb-6 text-gray-800">Performances & Concerts</h2>
            <div className="border-t border-gray-200 pt-6">
                ...
                <div className="flex-1 flex flex-col justify-between bg-white rounded-lg p-6 border border-orange-100">
                  <div>
                    <div className="flex items-center gap-4 mb-4">
                      ...
                      <div>
                        <div className="text-xl font-bold text-gray-800">HAMNAVAZAN E HESAR ENSEMBLE</div>
                        <div className="text-orange-500 font-semibold text-sm mt-1">LED BY MASTER ALI GHAMSARI</div>
                      </div>
                    </div>
                    <div className="text-gray-700 mb-4 text-base">
                      Ali Ghamsari is one of the successful young talents in Iranian music. He is a tar player and composer who has performed in various festivals. Ali Farbodnia has been collaborating with this young artist since 2017. One of their most notable collaborations is the ten-night successful performance of "Sanam-e-Nahanjar" at Arasbaran Hall in Tehran.
                    </div>
              ...
              <div className="flex flex-col md:flex-row gap-8 bg-[#f7f5f2] p-8 rounded-xl shadow-md items-stretch mt-12">
                ...
                <div className="flex-1 flex flex-col justify-between bg-white rounded-lg p-6 border border-orange-100">
                  <div>
                    <div className="flex items-center gap-4 mb-4">
                      ...
                      <div>
                        <div className="text-xl font-bold text-gray-800">VAZIRI MUSIC ORCHESTRA</div>
                        <div className="text-orange-500 font-semibold text-sm mt-1">BY MASTER KEYVAN SAKET</div>
                      </div>
                    </div>
                    <div className="text-gray-700 mb-4 text-base">
                      Keyvan Saket is one of the greatest contemporary Iranian musicians. He is the leader of the Vaziri music ensemble and has performed with this group around the world. Ali Farbodnia has been collaborating with this ensemble since 2009.
                    </div>
                  </div>
                ...
                <div className="flex-1 flex flex-col items-center justify-center">
                  ...
                  <div className="font-semibold text-xl mb-2">Vaziri Music Orchestra</div>
                  <div className="text-orange-600 font-medium text-base">Simorgh Hall, Neyshabur (2009) <span className='mx-2'>and</span> Vahdat Hall, Tehran (2020)</div>
                </div>
              </div>
              ...
              <div className="flex flex-col items-center bg-white rounded-xl p-8 mt-8">
                ...
                <div className="mt-8 text-center max-w-3xl text-gray-700">
                  He has participated as a ney player in recording various Iranian music albums and numerous concerts alongside Master Keyvan Saket. Notable performances include the Neyshabur concert in 2009 and the Vahdat Hall concert in 2020 with vocalist Vahid Taj.
                </div>
                ...
                <div className="flex-1 flex flex-col justify-between bg-white rounded-lg p-6 border border-orange-100">
                  <div>
                    <div className="flex items-center gap-4 mb-4">
                      ...
                      <div>
                        <div className="text-xl font-bold text-gray-800">FAJR FESTIVAL</div>
                        <div className="text-orange-500 font-semibold text-sm mt-1">KHANEYAGRAN-E-KHAYYAM ENSEMBLE</div>
                      </div>
                    </div>
                    <div className="text-gray-700 mb-4 text-base">
                      Khonyagaran-e-Khayyam music group is one of the best musical groups in eastern Iran, performing Iranian and folk music for the past 15 years. Major Achievements: Among the group's major achievements are being selected as the top group at the 34th Fajr International Music Festival in Tehran in 2019, and being the chosen group at the Mugham Music Festival in Azerbaijan in 2017. Ali Farbodnia continues to collaborate with this group in recording various music albums.<br/>
                      Ali Farbodnia has been working with this group since 2010 as a Ney player and, in some performances, as a composer.
                    </div>
                    <div className="text-orange-600 font-medium text-sm mb-2">34th Fajr International Music Festival, Azadi Hall, Tehran (2019)</div>
                  </div>
                </div>
                {/* Right: Poster/Image and below info */}
                <div className="flex-1 flex flex-col items-center justify-center">
                  ...
                  <div className="mt-2 inline-flex items-center gap-2 text-orange-600 font-medium text-base">
                    ...
                    <a href="https://youtu.be/iiWrVc084hE?si=2QoF-QYL2kuQKF1Y" target="_blank" rel="noopener noreferrer" className="hover:underline">Link: 34th Fajr International Music Festival, Azadi Hall, Tehran (2019)</a>
                  </div>
                </div>
              </div>
                ...
                <div className="flex-1 flex flex-col justify-between bg-white rounded-lg p-8 border border-orange-100">
                  <div>
                    <div className="flex items-center gap-4 mb-4">
                      ...
                      <div>
                        <div className="text-2xl font-bold text-gray-800 tracking-tight">MUGHAM FESTIVAL</div>
                        <div className="text-orange-500 font-semibold text-base mt-1 uppercase tracking-wide">KHANEYAGRAN-E-KHAYYAM ENSEMBLE</div>
                      </div>
                    </div>
                    <div className="bg-gray-50 rounded-lg p-4 mb-4 text-gray-700 text-base shadow-inner border border-gray-100">
                      Farbodnia, together with the musical ensemble "Khonyagaran-e-Khayyam," participated in the 2017 Mugham International Festival in Azerbaijan. The group was selected as one of the distinguished ensembles of that year and performed at the festival's closing ceremony held at the Azerbaijan State Conservatory. Farbodnia took part in the group as a Ney player and composer.
                    </div>
                  </div>
                  <div className="flex items-center gap-2 mt-8 text-orange-600 font-medium text-base">
                    ...
                    <a href="https://youtu.be/iiWrVc084hE?si=2QoF-QYL2kuQKF1Y" target="_blank" rel="noopener noreferrer" className="hover:underline">Link: Mugham International Music Festival, Azerbaijan (2017)</a>
                  </div>
                </div>
                {/* Right: Poster/Image */}
                <div className="flex-1 flex flex-col items-center justify-center">
                ...
                <div className="flex-1 flex flex-col justify-between bg-white rounded-lg p-8 border border-orange-100 min-w-[320px] max-w-lg">
                  <div>
                    <div className="flex items-center gap-4 mb-4">
                      ...
                      <div>
                        <div className="text-2xl font-bold text-gray-800 tracking-tight">THE BEST OF MASTER MOHAMADREZA LOTFI</div>
                        <div className="text-orange-500 font-semibold text-base mt-1 uppercase tracking-wide">2017 TEHRAN</div>
                      </div>
                    </div>
                    <div className="bg-gray-50 rounded-lg p-4 mb-4 text-gray-700 text-base shadow-inner border border-gray-100">
                      <span className="font-bold">The best of Master Mohamed Reza Lotfi</span><br/>
                ...
                <div className="flex-1 flex flex-col justify-between bg-white rounded-lg p-8 border-l-8 border-orange-400 min-w-[320px] max-w-lg">
                  <div>
                    <div className="flex items-center gap-4 mb-4">
                      ...
                      <div>
                        <div className="text-2xl font-bold text-gray-800 tracking-tight">FEYKSAHNE TAR BAND</div>
                        <div className="text-orange-500 font-semibold text-base mt-1 uppercase tracking-wide">ISTANBUL CONCERT 2024</div>
                      </div>
                    </div>
                    <div className="bg-gray-50 rounded-lg p-4 mb-4 text-gray-700 text-base shadow-inner border border-gray-100">
                      Music has always been the language of peace for humanity, and it serves as a messenger of peace and friendship among nations. In 2017, Ali Farbodnia founded the "Tar" music group with a group of his musician friends, focusing on local Iranian music. Iranian folk music has great potential for international performance, and he has always tried to create a new blend by incorporating instruments from different cultures.<br/><br/>
                      Some of the group's notable performances include the Tirgan Festival in Canada in 2022,<br/>
                      Istanbul Feyksahne Theater 2024<br/>
                ...
                <div className="flex-1 flex flex-col justify-between bg-white rounded-lg p-8 border-l-8 border-orange-400 min-w-[320px] max-w-lg">
                  <div>
                    <div className="flex items-center gap-4 mb-4">
                      ...
                      <div>
                        <div className="text-2xl font-bold text-gray-800 tracking-tight">SOHREH MUSIC GROUP</div>
                        <div className="text-orange-500 font-semibold text-base mt-1 uppercase tracking-wide">IZMIR 2022-SOHRE BAND</div>
                      </div>
                    </div>
                    <div className="bg-gray-50 rounded-lg p-4 mb-4 text-gray-700 text-base shadow-inner border border-gray-100">
                      Ali Farbodnia performed as a Ney player with the Iranian music group "Sohreh" in Izmir in 2022. In this performance, the Iranian vocalist Ms. Roya Raei joined the group as the singer, along with several renowned Iranian musicians such as Farhad Rajabi on tar, Nafiseh Tabatabaei on ney, and the group's leader and santur player Toofan Aytan. This performance was one of the memorable Iranian music events in Izmir.
                    </div>
                  </div>
                </div>
                {/* Right: Two stacked images */}
                ...
                <div className="flex-1 flex flex-col justify-between bg-white rounded-lg p-8 border-l-8 border-orange-400 min-w-[320px] max-w-lg">
                  <div>
                    <div className="flex items-center gap-4 mb-4">
                      ...
                      <div>
                        <div className="text-2xl font-bold text-gray-800 tracking-tight">ALEST MUSIC GROUP</div>
                        <div className="text-orange-500 font-semibold text-base mt-1 uppercase tracking-wide">IZMIR 2025-ALEST BAND</div>
                      </div>
                    </div>
                    <div className="bg-gray-50 rounded-lg p-4 mb-4 text-gray-700 text-base shadow-inner border border-gray-100">
            ...
            <div className="flex flex-col items-center justify-center py-20 px-4 bg-white border border-orange-200 rounded-b-2xl">
              ...
              <div className="flex flex-col gap-4 text-lg md:text-xl font-medium">
                <div className="flex items-center gap-4">
                  ...
                  <a href="mailto:a.farbodnia@gmail.com" target="_blank" rel="noopener noreferrer" className="text-gray-700 hover:text-orange-600 transition-colors">A.farbodnia@gmail.com</a>
                </div>
                <div className="flex items-center gap-4">
                  <span className="bg-black text-white rounded-full p-2 text-2xl flex items-center justify-center"><FaYoutube /></span>
                  <span className="bg-orange-200 rounded-full p-2 text-xl flex items-center justify-center"><FaLink /></span>
                  <a href="https://youtube.com/@alifarbodnia?si=brU9QaL-TaX8eqCF" target="_blank" rel="noopener noreferrer" className="text-gray-700 hover:text-orange-600 transition-colors">My Youtube</a>
                </div>
                <div className="flex items-center gap-4">
                  <span className="bg-black text-white rounded-full p-2 text-2xl flex items-center justify-center"><FaInstagram /></span>
                  <span className="bg-orange-200 rounded-full p-2 text-xl flex items-center justify-center"><FaLink /></span>
                  <a href="https://www.instagram.com/alifarbodnia/profilecard/?igsh=MXI3Z2xyd2h4cTNobQ==" target="_blank" rel="noopener noreferrer" className="text-gray-700 hover:text-orange-600 transition-colors">My Instagram</a>
                </div>
                <div className="flex items-center gap-4">
                  <span className="bg-black text-white rounded-full p-2 text-2xl flex items-center justify-center"><FaLink /></span>
                  <span className="bg-orange-200 rounded-full p-2 text-xl flex items-center justify-center"><FaLink /></span>
                  <a href="https://www.fiverr.com/s/xX7kD9a" target="_blank" rel="noopener noreferrer" className="text-gray-700 hover:text-orange-600 transition-colors">My Fiverr</a>
                </div>
                <div className="flex items-center gap-4">
                  <span className="bg-black text-white rounded-full p-2 text-2xl flex items-center justify-center"><FaSpotify /></span>
                  <span className="bg-orange-200 rounded-full p-2 text-xl flex items-center justify-center"><FaLink /></span>
                  <a href="https://open.spotify.com/artist/7s8YtMTj8iNp9PUVX3a3CS?si=EtS7qZmJTsaCvVXtKuHQCQ" target="_blank" rel="noopener noreferrer" className="text-gray-700 hover:text-orange-600 transition-colors">My Spotify</a>
                </div>
              </div>
            </div>
